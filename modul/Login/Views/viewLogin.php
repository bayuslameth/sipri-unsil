                ...
                <div class="w-px-400 mx-auto">
                    ...
                    <form id="form" class="mb-3" action="javascript:void(0)" method="POST">
                        ...
                        <div class="mb-3 form-password-toggle">
                            ...
                            <p id="invalid-password" class="mt-2 mb-0" style="color: #ff3c1c; font-size: 0.875em;"></p>
                        </div>
                        <div class="mb-3">
                        ...
                        <button class="btn btn-primary d-grid w-100" id="submit">Masuk</button>
                    </form>

                    <p class="text-center">
                        <span>Baru di Sipri Unsil?</span>
                        <a href="/register">
    ...
    $(document).ready(function() {
        ...
        $('#form').submit(function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $("#submit").html(
                        '<span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span> Masuk'
                    ).addClass("disabled");
                },
                complete: function() {
