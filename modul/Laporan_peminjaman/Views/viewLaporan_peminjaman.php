    ...
    <div class="card">
        <div class="row card-header flex-column flex-md-row">
            <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto mt-0">
                <h5 class="card-title mb-0 text-md-start text-center text-dark">Laporan Peminjaman</h5>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalLabel">Detail Peminjaman</h1>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="tujuan" rows="3" readonly></textarea>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Tanggal Mulai</label>
                        <input type="text" class="form-control" id="tanggal_mulai" readonly>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="waktu_mulai" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Waktu Selesai</label>
                        <input type="text" class="form-control" id="waktu_selesai" readonly>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Durasi (menit)</label>
                        <input type="text" class="form-control" id="durasi_menit" readonly>
                    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    table = $('#table').DataTable({
        ...
        order: [],
        ajax: {
            url: '/laporan-peminjaman/datatable',
            method: 'POST',
        },
        columns: [{
                data: 'no',
...
function detail(id) {
    $.ajax({
        type: "POST",
        url: "/laporan-peminjaman/getData",
        data: { id: id },
        dataType: "JSON",
        beforeSend: function() {
        },
        success: function(res) {
            if (res.status && res.data) {
                ...
                $('#tujuan').val(d.tujuan || '-');
                $('#tanggal_mulai').val(formatDate(d.tanggal_mulai));
                $('#tanggal_selesai').val(formatDate(d.tanggal_selesai));
                $('#waktu_mulai').val(d.waktu_mulai || '-');
                $('#waktu_selesai').val(d.waktu_selesai || '-');
                $('#status').val(d.status || '0');
                $('#durasi_menit').val(d.durasi_menit ? d.durasi_menit + ' menit' : '-');

                $('#modalLabel').text('Detail Peminjaman - ' + (d.nama_peminjam || 'ID ' + d.id));
